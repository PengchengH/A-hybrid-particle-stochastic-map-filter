...
classdef TransportMap
    ...
    methods  
        function TM = TransportMap(d, order, options, varargin)
            ...
            addRequired(p,'d');
            addRequired(p,'order');
            parse(p,d,order,varargin{:}); %here with varargin, extra input would throw error
        ...
        %------------------------------------------------------------------
        %------------------------------------------------------------------
        function Z = eval_map(TM, X, d_scale)
        ...
        %------------------------------------------------------------------
        %------------------------------------------------------------------
        function X = eval_inv_map(TM, Z, scale)
        ...
        %------------------------------------------------------------------
        %------------------------------------------------------------------
        function dSx = grad_x(TM,X,d_scale)
