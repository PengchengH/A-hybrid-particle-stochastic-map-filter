...
classdef NonMonotonePart
	...
	methods
        % NonMonotonePart: define class NonMonotonePart and give basic set
        % ncoeff: Calculate the number of coffects for nonmonotone part(RBF+2erf)
        % set_zero_function: set the output of nonmonotonepart be zero.
        
        % evaluate: evaluate the value of RBF model based on the cached basis evaluations
        % grad_x: evaluate the gradient of nonmonotone RBFs based on the cached basis
        % hess_x:  % evaluate hessians of the linear+RBF model based on the ncoeff and
            ...
            % basis_hess:  % the Hessian of basis
                % eval_RBF: evaluate the value of basis at samples X.
                % grad_x_RBF: evaluate the gradient of basis at samples X.
                % hess_x_RBF: evaluate the Hessian of basis at samples X.
		...
		%------------------------------------------------------------------
		%------------------------------------------------------------------
        function d = ncoeff(NMP)  % the number of coeffects for non-monotone terms
        	d = sum(NMP.order);
        end %endFunction
		%------------------------------------------------------------------
		%------------------------------------------------------------------
        function NMP = set_zero_function(NMP) % set non-monotone terms be zero
            NMP.constTerm = 0;
        ...
        % Calculate the value of non-monotone terms with the constant term.
        ...
        % the value of basis (basic terms for non-monotone)on the 
        % samples X.
        ...
        % the gradient of basis (basic terms for non-monotone)on the 
        % samples X.
        ...
        % the Hessian of basis (basic terms for non-monotone)on the 
        % samples X.
